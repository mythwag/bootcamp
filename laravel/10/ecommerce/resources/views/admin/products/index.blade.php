        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mb-4 flex justify-between items-center">
                    ...
                    <a href="{{ route('products.create') }}" style="background-color: #4CAF50; color: white; padding: 8px 16px; border-radius: 6px; font-weight: bold; text-decoration: none; font-size: 14px;">
                        + Tambah Produk
                    </a>
                </div>
                            ...
                            @forelse($products as $product)
                                <tr style="border-bottom: 1px solid #eee;">
                                    ...
                                    <td style="padding: 12px; text-align: center; white-space: nowrap;">
                                        <a href="{{ route('products.edit', $product->id) }}" style="color: #4CAF50; font-weight: 600; text-decoration: none; margin-right: 12px; font-size: 14px;">Edit</a>
